...
import { FaBook, FaEdit, FaUndo, FaArrowLeft, FaArrowRight, FaBookOpen, FaBookReader, FaRupeeSign } from "react-icons/fa";
  ...
  const handleClearFine = async () => {
    try {
      ...
      const res = await api.put(
        `/api/issue/clear-fine/${selectedIssue._id}`
      );
      ...
      ${item.user?.role === "student"
                        ...
                        <div className="flex justify-start gap-4 text-lg whitespace-nowrap">
                          ...
                          <CustomToolTip text="Return">
                            <FaUndo
                              ...
                              className={`mt-0.5 transition ${item.status === "returned"
                                ? "text-gray-300 cursor-not-allowed"
                                : "cursor-pointer text-gray-600 hover:scale-110"
                                }`} />
                          </CustomToolTip>

                          <CustomToolTip text="Clear Fine">
                            <FaRupeeSign
                              size={13}
                              onClick={() => {
                                if (item.fine > 0) {
                              ...
                              className={` mt-0.5 transition  ${item.fine > 0
                                ? "cursor-pointer text-gray-600 hover:scale-110"
                                : "text-gray-300 cursor-not-allowed"
                                }`}
                            />
        ...
        {showFine && (
          <div className="fixed inset-0 bg-black/70 backdrop-blur flex items-center justify-center z-1100">
            ...
            <div className="bg-white rounded-lg shadow-lg w-100 p-5">
              ...
              <p className="mb-4 text-gray-600">
                Are you sure you want to clear this fine?
              </p>

              <p className="mb-4 font-medium">
                Amount: ₹{selectedIssue?.fine}
              </p>
